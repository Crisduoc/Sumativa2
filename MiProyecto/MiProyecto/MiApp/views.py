...
def vista_protegida(request):
    return render(request, 'MiApp/protegida.html')

@login_required
def listar_productos(request):
    productos = Producto.objects.all()
    return render(request, 'MiApp/listar.html', {'productos': productos})
...
def crear_producto(request):
    if request.method == 'POST':
        ...
        form = ProductoForm()
    return render(request, 'MiApp/crear.html', {'form': form})
...
def editar_producto(request, pk):
    ...
    return render(request, 'MiApp/editar.html', {'form': form})
...
def eliminar_producto(request, pk):
    ...
    if request.method == 'POST':
        producto.delete()
        return redirect('listar_productos')
    return render(request, 'MiApp/eliminar.html', {'producto': producto})
